...
/**
 * <p>Java class for HostUpdateVStorageObjectMetadataExRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="HostUpdateVStorageObjectMetadataExRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "HostUpdateVStorageObjectMetadataExRequestType", propOrder = {
    "_this",
    "id",
    "datastore",
    "metadata",
...
public class HostUpdateVStorageObjectMetadataExRequestType {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the deleteKeys property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<String> getDeleteKeys() {
        if (deleteKeys == null) {
            deleteKeys = new ArrayList<String>();
        }
