...
/**
 * <p>Java class for ArrayOfVirtualPCIPassthroughAllowedDevice complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="VirtualPCIPassthroughAllowedDevice" type="{urn:vim25}VirtualPCIPassthroughAllowedDevice" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfVirtualPCIPassthroughAllowedDevice {
     ...
     * This is why there is not a <CODE>set</CODE> method for the virtualPCIPassthroughAllowedDevice property.
     * 
     * <p>
    ...
    public List<VirtualPCIPassthroughAllowedDevice> getVirtualPCIPassthroughAllowedDevice() {
        if (virtualPCIPassthroughAllowedDevice == null) {
            virtualPCIPassthroughAllowedDevice = new ArrayList<VirtualPCIPassthroughAllowedDevice>();
        }
