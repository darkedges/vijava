 ...
 *         &lt;element name="sharedGpuCapabilities" type="{urn:vim25}HostSharedGpuCapabilities" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="assignableHardwareBinding" type="{urn:vim25}HostAssignableHardwareBinding" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="assignableHardwareConfig" type="{urn:vim25}HostAssignableHardwareConfig" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends DynamicData
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sharedGpuCapabilities property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<HostSharedGpuCapabilities> getSharedGpuCapabilities() {
        if (sharedGpuCapabilities == null) {
            sharedGpuCapabilities = new ArrayList<HostSharedGpuCapabilities>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the assignableHardwareBinding property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<HostAssignableHardwareBinding> getAssignableHardwareBinding() {
        if (assignableHardwareBinding == null) {
            assignableHardwareBinding = new ArrayList<HostAssignableHardwareBinding>();
        }
