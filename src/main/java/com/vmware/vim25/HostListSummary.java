 ...
 *         &lt;element name="trustAuthorityAttestationInfos" type="{urn:vim25}HostTrustAuthorityAttestationInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends DynamicData
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the trustAuthorityAttestationInfos property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<HostTrustAuthorityAttestationInfo> getTrustAuthorityAttestationInfos() {
        if (trustAuthorityAttestationInfos == null) {
            trustAuthorityAttestationInfos = new ArrayList<HostTrustAuthorityAttestationInfo>();
        }
