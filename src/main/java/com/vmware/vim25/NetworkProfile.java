 ...
 *         &lt;element name="nsxHostNic" type="{urn:vim25}NsxHostVNicProfile" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="netStackInstance" type="{urn:vim25}NetStackInstanceProfile" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="opaqueSwitch" type="{urn:vim25}OpaqueSwitchProfile" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends ApplyProfile
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the nsxHostNic property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<NsxHostVNicProfile> getNsxHostNic() {
        if (nsxHostNic == null) {
            nsxHostNic = new ArrayList<NsxHostVNicProfile>();
        }
    ...
    public List<NetStackInstanceProfile> getNetStackInstance() {
        if (netStackInstance == null) {
            netStackInstance = new ArrayList<NetStackInstanceProfile>();
        }
