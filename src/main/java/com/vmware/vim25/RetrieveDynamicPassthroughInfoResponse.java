 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}VirtualMachineDynamicPassthroughInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class RetrieveDynamicPassthroughInfoResponse {
    ...
    public List<VirtualMachineDynamicPassthroughInfo> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<VirtualMachineDynamicPassthroughInfo>();
        }
