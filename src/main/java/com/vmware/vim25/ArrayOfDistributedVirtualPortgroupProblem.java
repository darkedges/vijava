...
/**
 * <p>Java class for ArrayOfDistributedVirtualPortgroupProblem complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="DistributedVirtualPortgroupProblem" type="{urn:vim25}DistributedVirtualPortgroupProblem" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfDistributedVirtualPortgroupProblem {
     ...
     * This is why there is not a <CODE>set</CODE> method for the distributedVirtualPortgroupProblem property.
     * 
     * <p>
    ...
    public List<DistributedVirtualPortgroupProblem> getDistributedVirtualPortgroupProblem() {
        if (distributedVirtualPortgroupProblem == null) {
            distributedVirtualPortgroupProblem = new ArrayList<DistributedVirtualPortgroupProblem>();
        }
