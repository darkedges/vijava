...
/**
 * <p>Java class for ArrayOfTaskInfoState complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="TaskInfoState" type="{urn:vim25}TaskInfoState" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfTaskInfoState {
     ...
     * This is why there is not a <CODE>set</CODE> method for the taskInfoState property.
     * 
     * <p>
    ...
    public List<TaskInfoState> getTaskInfoState() {
        if (taskInfoState == null) {
            taskInfoState = new ArrayList<TaskInfoState>();
        }
